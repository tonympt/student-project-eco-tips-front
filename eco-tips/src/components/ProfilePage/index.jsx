      ...
      {loading ? (<Spinner />) : (
        <>
          <div className="absolute top-4 left-2">
            <span aria-label="score" className="text-xl bg-blue-100 text-blue-800 font-medium mr-2 px-2 py-2.5 rounded-md">
              {' '}
              🏆
              {' '}
              {score}
          ...
          <div className="absolute top-4 right-2">
            <span aria-label="coin" className="bg-yellow-100 text-yellow-800 font-medium mr-2 px-2 py-2.5 rounded-md text-xl">
              {' '}
              💰
              {' '}
              {ecocoins}
