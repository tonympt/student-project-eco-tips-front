      ...
      <nav className="flex flex-wrap content-center space-x-2">
        ...
        <div className={`absolute top-full left-0 ${menuOpen ? 'block bg-white border rounded-b-lg border-x-1 border-b-1' : 'hidden'}`}>
          <ul className="flex flex-col gap-2 py-2">
            <li>
              <NavLink to="/profile/:id" activeClassName="" className="flex flex-row gap-2 text-gray-700 block px-4 py-1 hover:border-l-4  border-green-600 hover:text-green-600">
            ...
            <li>
              <NavLink to="/collection/:id" activeClassName="" className="flex flex-row gap-2 text-gray-700 block px-4 py-1 hover:border-l-4  border-green-600 hover:text-green-600">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
            ...
            <li>
              <NavLink to="/community" activeClassName="" className="flex flex-row gap-2 text-gray-700 block px-4 py-1 border-green-600 hover:border-l-4 hover:text-green-600">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
