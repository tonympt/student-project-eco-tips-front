...
function ButtonsControls({ card }) {
  ...
  function getUrlParams(inputString) {
  ...
  const urlParams = getUrlParams(image);
  ...
  return (
    <div className="flex w-full content-center gap-3 place-content-evenly m-2">
      ...
      <Link
        to={{
          pathname: `/admin/proposals/${urlParams}`,
          state: { carDatas: allCardDatas },
        }}
      >
        <Button
          width="w-10"
