...
function ButtonsControls({ achievement }) {
  ...
  const handleDelete = () => {
    setModalText('Êtes-vous sûr de vouloir supprimer l\'accomplissement ?');
  ...
  const handleValidation = () => {
    setModalText('Êtes-vous sûr de vouloir valider l\'accomplissement ?');
  ...
  return (
    <div className="flex w-full content-center gap-3 place-content-evenly m-2">
      ...
      <Link
        to={`/achievement/proposal/${urlParams}`}
        state={{ achievementDatas: allAchievementDatas }}
      >
        <Button
          type="button"
          color="blue"
